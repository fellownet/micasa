...
const routes: Routes = [
	...
	{ path: 'screens/:screen_id/device/:device_id',      component: DeviceDetailsComponent, canActivate: [SessionGuard], resolve: { screen: ScreenResolver, device: DeviceResolver, data: DataResolver } },
