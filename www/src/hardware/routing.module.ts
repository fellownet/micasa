...
const routes: Routes = [
	...
	{ path: 'hardware/:hardware_id/device/:device_id',                 component: DeviceDetailsComponent, canActivate: [SessionGuard], resolve: { hardware: HardwareResolver, device: DeviceResolver } },
	{ path: 'hardware/:parent_id/:hardware_id/device/:device_id',      component: DeviceDetailsComponent, canActivate: [SessionGuard], resolve: { hardware: HardwareResolver, device: DeviceResolver } },
	{ path: 'hardware/:hardware_id/device/:device_id/edit',            component: DeviceEditComponent,    canActivate: [SessionGuard], resolve: { hardware: HardwareResolver, device: DeviceResolver, scripts: ScriptsListResolver, timers: TimersListResolver, screens: ScreensListResolver, links: LinksListResolver } },
	{ path: 'hardware/:parent_id/:hardware_id/device/:device_id/edit', component: DeviceEditComponent,    canActivate: [SessionGuard], resolve: { hardware: HardwareResolver, device: DeviceResolver, scripts: ScriptsListResolver, timers: TimersListResolver, screens: ScreensListResolver, links: LinksListResolver } }
];
