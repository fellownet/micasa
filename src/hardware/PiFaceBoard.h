...
namespace micasa {
	...
	public:
		PiFaceBoard( const unsigned int id_, const std::string reference_, const std::shared_ptr<Hardware> parent_, std::string label_ ) : Hardware( id_, reference_, parent_, label_ ) { };
		~PiFaceBoard() { };
