...
public:
    ...
    tlv_t        TLVFromBuffer(uint8_t * stream, int8_t type, int16_t size);
    tlv_t        TLVAppendBuffers(uint8_t * stream1, uint8_t * stream2, int8_t type, int16_t size1, int16_t size2);
